...
public class sendMessage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          Integer senderId = (Integer) session.getAttribute("idUsuario");
        Integer receiverId = 10;
        String content = request.getParameter("content");
        
        try (Connection conn = SqlConection.getConnection()) {
            String sql = "INSERT INTO Mensajes (sender_id, receiver_id, contenido) VALUES (?, ?, ?)";
            ...
            response.getWriter().write("Error al enviar el mensaje: " + e.getMessage());
        }
    }
